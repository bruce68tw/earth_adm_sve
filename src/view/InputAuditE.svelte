<XgEditForm {crudE} bind:this={form} progName="入庫單審核" showMode={false} fnSetVm={setVm} >
    <XiRead value={vm.Id} title='入庫單號' {cols} />
    <XiText {vm} fid='Note' title='內容說明' edit='' {cols} />
    <XiRead value={vm.DonateId+'-'+vm.DonateTitle } title='捐贈單號' {cols} />
