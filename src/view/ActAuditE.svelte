<XgEditForm {crudE} bind:this={form} progName="活動單審核" showMode={false} fnSetVm={setVm} >
    <XiRead value={vm.Id} title='活動單號' {cols} />
    <XiText {vm} fid='Name' title='活動名稱' edit='' {cols} />
    <XiTextarea {vm} fid='Note' title='內容說明' edit='' {cols} rowsCount={3} />
